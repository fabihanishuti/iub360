   ...
   <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
         <div class="flex items-center justify-start">
            <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-white hover:text-gray-900 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
               <span class="sr-only">Open sidebar</span>
               <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
               </svg>
            </button>
            <a href="./index.php" class="pl-2 flex ml-2 md:mr-24">
               <img src="https://seeklogo.com/images/I/independent-university-logo-776F5F3A69-seeklogo.com.png" class="h-8 mr-3" alt="IUB Logo" />
               <span class="pl-4 self-center text-xl text-white font-semibold sm:text-2xl whitespace-nowrap">IUB 360</span>
               <span class="mx-8 text-3xl text-white"> | </span>
               <span>
                  <div class="self-center text-sm text-white whitespace-nowrap">Idea, Innovation and Technology</div>
                  <div class="self-center text-sm text-white whitespace-nowrap">A Student Enrichment Professor</div>
               </span>
            </a>
         </div>
         <div class="flex items-center">
            <div>
               <!-- Notifications -->
               <button type="button" data-dropdown-toggle="notification-dropdown" class="p-2 mr-1 text-white rounded-lg hover:text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-300">
               ...
               <!-- Dropdown menu -->
               <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg rounded-xl" id="notification-dropdown">
                  ...
                  <div>
                     <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                        <div class="flex-shrink-0">
                           ...
                           <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-blue-700">
                        ...
                        <div class="pl-3 w-full">
                           <div class="text-gray-500 font-normal text-sm mb-1.5">
                              New message from
                              <span class="font-semibold text-gray-900">Bonnie Green</span>: "Hey, what's up? All set for the presentation?"
                           </div>
                     ...
                     <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                        ...
                        <div class="pl-3 w-full">
                           <div class="text-gray-500 font-normal text-sm mb-1.5">
                              ...
                              love your blog. See it and view more blogs.
                           </div>
                           <div class="text-xs font-medium text-blue-600">
                              44 minutes ago
                           </div>
                     ...
                     <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                        ...
                        <div class="pl-3 w-full">
                           <div class="text-gray-500 font-normal text-sm mb-1.5">
                              ...
                              mentioned you in a forum:
                              <span class="font-medium text-blue-600">@bonnie.green</span>
                              Lacking explanation. Please explain...
                           </div>
                           <div class="text-xs font-medium text-blue-600">
                              1 hour ago
                           </div>
                     ...
                     <a href="#" class="flex py-3 px-4 hover:bg-gray-100">
                        ...
                        <div class="pl-3 w-full">
                           <div class="text-gray-500 font-normal text-sm mb-1.5">
                              ...
                              posted a new guide: Startup - learn how to implement
                              the new trend.
                           </div>
                           <div class="text-xs font-medium text-blue-600">
                              3 hours ago
            ...
            <div class="flex items-center ml-3">
               ...
               <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow" id="dropdown-user">
                  ...
                  <ul class="py-1" role="none">
                     ...
                     <li>
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">User view</a>
                     </li>
                  </ul>
                  <li>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-blue-900 border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-blue-900">
      <ul class="space-y-2 font-medium">
         <li>
            <a href="#" class="flex items-center p-2 text-white hover:text-gray-900 rounded-lg hover:bg-gray-100 group">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-white hover:text-gray-900 rounded-lg hover:bg-gray-100 group">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap">Job Offers</span>
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-white hover:text-gray-900 rounded-lg hover:bg-gray-100 group">
               <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-white hover:text-gray-900 rounded-lg hover:bg-gray-100">
               <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
